	...
	<div class="project-card">
		...
		{#if activeTab === tabs[0]}
			<div class="overview">
				...
				<div class="links">
					<a target="_blank" rel="external" href="https://www.geyix.org">Click For Preview</a>
					<a href=""
		...
		{:else}
			<div class="tech">
				<div class="tech-sec">
					<h4 class="sections">Backend</h4>
					<ul>
						{#each project.usedTech.backend as item}
							<li>{item}</li>
						{/each}
					</ul>
				</div>
				<div class="tech-sec">
					<h4 class="sections">Frontend</h4>
					<ul>
						{#each project.usedTech.frontend as item}
							<li>{item}</li>
						{/each}
					</ul>
				</div>
